...
import { Bus, Package, Shield, Clock, Wifi, Coffee, Zap } from "lucide-react"
...
const services = [
  ...
  {
    icon: Zap,
    title: "Ports de Recharge",
    description: "Prises USB et ports de recharge disponibles à chaque siège",
  },
  {
    icon: Coffee,
